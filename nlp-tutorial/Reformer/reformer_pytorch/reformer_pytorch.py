"""
Reference: https://arxiv.org/pdf/2001.04451v1
https://github.com/lucidrains/reformer-pytorch/tree/master
"""
import math
import torch
...
# pip3 install local-attention
from local_attention import LocalAttention
# pip3 install axial_positional_embedding
from axial_positional_embedding import AxialPositionalEmbedding
# pip install product_key_memory
from product_key_memory import PKM
from Reformer.reformer_pytorch.reversible import ReversibleSequence
...
class ReformerLM(nn.Module):
    def __init__(self, num_tokens, dim, depth, max_seq_len, heads=8, dim_head=64, bucket_size=64, n_hashes=4,
                 ...
                 return_embeddings=False, weight_tie_embedding=False, fixed_position_emb=False,
                 absolute_position_emb=False, axial_position_emb=False, axial_position_shape=None, n_local_attn_heads=0,
